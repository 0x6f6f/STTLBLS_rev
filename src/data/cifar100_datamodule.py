...
class CIFAR100DataModule(LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            trainset = CIFAR100(self.hparams.data_dir, train=True, transform=self.transforms[0])
            testset = CIFAR100(self.hparams.data_dir, train=False, transform=self.transforms[1])
